...
<head>
    <meta charset="UTF-8">
    <title>FitConnect — Ajouter une salle</title>
        ...
        <div class="box">
            ...
            <form method="POST">
                <div class="field">
                    ...
                    <input type="text" name="nom_salle" placeholder="Ex: Fitness Pro" required>
                </div>
                <div class="field">
                    <label>Adresse</label>
                    <input type="text" name="adresse" placeholder="Ex: Rue Hassan II" required>
                </div>
                <div class="field">
                    <label>Téléphone</label>
                    <input type="text" name="telephone" placeholder="Ex: 0523456789" required>
                </div>
