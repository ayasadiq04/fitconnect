...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: sans-serif; }
        ...
        .field select, .field input { width: 100%; padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; outline: none; }
        ...
        .btn-submit { background: #10b981; color: #ffffff; border: none; padding: 10px 20px; font-size: 14px; font-weight: 600; border-radius: 6px; cursor: pointer; }
        ...
        <div class="box">
            ...
            <form method="POST">
                ...
                <div class="grid-2">
                    ...
                    <div class="field">
                        <label>Durée</label>
                        <input type="time" name="duree" value="01:00:00" required>
                    </div>
                </div>
                <div class="field">
                    <label>Équipement</label>
                    <input type="text" name="equipement" placeholder="Ex: Haltères, Tapis roulant..." required>
                </div>
                <div class="grid-2">
                    <div class="field">
